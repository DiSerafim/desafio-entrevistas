  ...
  return (
    <>
      ...
      <header className="top">
        ...
        <form action="">
          <input type="search" id="gsearch" name="gsearch" placeholder="Qual o mimo de hoje para o seu anjinho?" className="search" />
        ...
        <div className='btn'>
          ...
          <p className="icon-text-user">MINHA CONTA</p>
          <p className="icon-text-cart">CARRINHO</p>
        </div>
      </header>
      ...
      <main className='content'>
        ...
        <div className='card'>
          <img src='https://png.pngtree.com/background/20210710/original/pngtree-blue-striped-cartoon-candy-mother-and-baby-promotion-banner-picture-image_1017537.jpg' alt='bebe' />
        ...
        <div className='card'>
          <img src='https://png.pngtree.com/background/20210710/original/pngtree-blue-striped-cartoon-candy-mother-and-baby-promotion-banner-picture-image_1017537.jpg' alt='' />
          <p className="title">Lorem ipsum lorem ipsum</p>
          <p className="price">R$ 99,99</p>
          <p className="rating">⭐ ⭐ ⭐ ⭐ ⭐</p>
          <button>
      ...
      <footer>
        ...
        <div className='newsletter'>
          ...
          <form>
            ...
            <input type="search" id="gsearch" name="gsearch" placeholder="Digite aqui o seu melhor e-mail" />
          </form>
        </div>
        ...
        <div className='sociais'>
          ...
          <img src={cards} alt='cartões bandeiras' />
        </div>
